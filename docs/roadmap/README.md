...
> **Current shipped head: v0.3.0** (2026-06-11, Anthropic interleaved tool-use end-to-end).
> **Initiative 1 (tool spec foundation) is ✅ complete.** Next up: Initiative 1.5
> (observability foundation, v0.3.5–v0.3.6). See
...
| Version | Plan | Theme |
|---|---|---|
| v0.3.5 | [Trace plumbing](observability-foundation-2026-06/v0.3.5-trace-plumbing.md) | `trace_id` propagation; SQLite trace table; auto-instrument the v0.3 StateGraph + dispatcher + outbound boundary. **First `bun:sqlite` touch in the rewrite — establishes WAL / migration patterns that v0.4 reuses.** |
