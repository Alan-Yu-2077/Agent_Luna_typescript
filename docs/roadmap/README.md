...
> **Main head: v0.23.4** (branch `feat/weather-perception`). **Next: Initiative 17 — Proactive parity restore (📋 PLANNED, v0.24.0–v0.24.2), then Initiative 18 — Collapsible companion UI (📋 PLANNED, v0.25.0–v0.25.2), then Initiative 19 — Desktop app (📋 PLANNED, v0.26.0–v0.26.2).** **Initiatives 8–12 all ✅ shipped + merged**: code-agent capability
...
## Initiative 17 — Proactive parity restore (the silence ladder) (v0.24.0 – v0.24.2) — 📋 PLANNED
...
## Initiative 18 — Collapsible companion UI (bubble stack + model glide) (v0.25.0 – v0.25.2) — 📋 PLANNED
...
## Initiative 19 — Desktop app (Luna lives on your screen) (v0.26.0 – v0.26.2) — 📋 PLANNED
