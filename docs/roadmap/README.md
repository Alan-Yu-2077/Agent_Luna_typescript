...
> **Main head: v0.25.2** (branch `feat/weather-perception`). **Initiatives 17 (silence ladder) + 18 (companion UI) + 19 (desktop app) ✅ SHIPPED 2026-07-02.** **Initiatives 8–12 all ✅ shipped + merged**: code-agent capability
