...
> **Current shipped head: v0.15.4** (2026-06-15, **Initiative 8 — code-agent capability — complete**:
> sandbox + read/nav + edit + sandboxed shell + verify loop + repo map/locator + skill library +
> propose-only firewalled self-edit — merged to main in `b5e68b3`, all flag-gated default-on, 525 tests
> green). Built in an isolated dev worktree, then merged.
