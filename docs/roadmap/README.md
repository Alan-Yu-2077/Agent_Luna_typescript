...
> **Initiative 16 — OpenAI-protocol adapter 🟡 PLANNED** (v0.23.0–v0.23.3): the chat path is hardwired to
...
## Initiative 16 — OpenAI-protocol adapter (model compatibility) (v0.23.0 – v0.23.3) — 🟡 PLANNED
