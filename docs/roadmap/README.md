...
> **Main head: v0.23.4** (branch `feat/weather-perception`). **Next: Initiative 17 — Proactive parity restore (📋 PLANNED, v0.24.0–v0.24.2), then Initiative 18 — Collapsible companion UI (📋 PLANNED, v0.25.0–v0.25.2).** **Initiatives 8–12 all ✅ shipped + merged**: code-agent capability
