...
> **Main head: v0.25.2** (branch `feat/weather-perception`). **Initiatives 17 (proactive silence ladder) + 18 (collapsible companion UI) ✅ SHIPPED 2026-07-02. Next: Initiative 19 — Desktop app (📋 PLANNED, v0.26.0–v0.26.2).** **Initiatives 8–12 all ✅ shipped + merged**: code-agent capability
