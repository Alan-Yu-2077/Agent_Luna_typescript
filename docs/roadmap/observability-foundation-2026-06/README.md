...
|---|---|---|---|---|---|
| [Trace plumbing](v0.3.5-trace-plumbing.md) | v0.3.5 | `trace_id` + SQLite trace schema + auto-instrument every dispatcher / outbound / StateGraph-transition point | Medium (first `bun:sqlite` touch; establishes WAL + migration pattern) | v0.3.0 | ⏳ planned |
