...
export const ACTIONS: Record<string, ActionDef> = {
  ...
  // v0.43.11 — the two gestures that make `thinking` read as thinking. Data only: the action layer
  // already knows how to sample a track, so "she is remembering something" is a table entry.
  // Eyes-up-and-right with the head following a little: the posture of retrieval, not of looking at
  // you. No `eyeOpen` track — the eyelids belong to the blink (v0.43.0's invariant).
  gazeUpRecall: { durationMs: 1600, tracks: { gazeX: [{ at: 0, value: 0 }, { at: 0.24, value: 0.3 }, { at: 0.66, value: 0.34 }, { at: 1, value: 0 }], gazeY: [{ at: 0, value: 0 }, { at: 0.24, value: -0.28 }, { at: 0.66, value: -0.32 }, { at: 1, value: 0 }], headPitch: [{ at: 0, value: 0 }, { at: 0.26, value: -5.2 }, { at: 0.7, value: -3.6 }, { at: 1, value: 0 }], headYaw: [{ at: 0, value: 0 }, { at: 0.26, value: 3.4 }, { at: 0.7, value: 2.2 }, { at: 1, value: 0 }], browLY: [{ at: 0, value: 0 }, { at: 0.3, value: 0.16 }, { at: 0.72, value: 0.1 }, { at: 1, value: 0 }], browRY: [{ at: 0, value: 0 }, { at: 0.3, value: 0.18 }, { at: 0.72, value: 0.12 }, { at: 1, value: 0 }] } },
  // A short knit and release — weighing it, rather than retrieving it.
  browKnit: { durationMs: 900, tracks: { browLY: [{ at: 0, value: 0 }, { at: 0.3, value: -0.34 }, { at: 0.68, value: -0.24 }, { at: 1, value: 0 }], browRY: [{ at: 0, value: 0 }, { at: 0.3, value: -0.32 }, { at: 0.68, value: -0.22 }, { at: 1, value: 0 }], browLAngle: [{ at: 0, value: 0 }, { at: 0.3, value: -0.26 }, { at: 0.68, value: -0.18 }, { at: 1, value: 0 }], browRAngle: [{ at: 0, value: 0 }, { at: 0.3, value: -0.26 }, { at: 0.68, value: -0.18 }, { at: 1, value: 0 }], eyeSquintL: [{ at: 0, value: 0 }, { at: 0.34, value: 0.14 }, { at: 0.7, value: 0.08 }, { at: 1, value: 0 }], eyeSquintR: [{ at: 0, value: 0 }, { at: 0.34, value: 0.14 }, { at: 0.7, value: 0.08 }, { at: 1, value: 0 }] } },
};
